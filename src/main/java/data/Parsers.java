...
public class Parsers {
    ...
    public List<User> parseResultSetIntoUserList(ResultSet result) throws SQLException {
    ...
    public PreparedStatement prepareUser(PreparedStatement preparedStmt, User newUser) throws SQLException {
    ...
    public HashMap<String, String[]> parseUserRequirementsIntoHashMap(UserRequirements requirements) {
    ...
    public List<Book> parseResultSetIntoBookList(ResultSet result) throws SQLException {
    ...
    public PreparedStatement prepareBook(PreparedStatement preparedStmt, Book newBook) throws SQLException {
    ...
    public HashMap<String, String[]> parseBookRequirementsIntoHashMap(BookRequirements requirements) {
        HashMap<String, String[]> requirementsMap = new HashMap<>();
    ...
    public ArrayList<String> parseFieldsArrayIntoStringList(Field[] fields) {
    ...
    public String resourceName(String tableName) {
